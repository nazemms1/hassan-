...
const supabaseUrl = 'https://qagyqmnreozzksfgsuft.supabase.co'
const supabaseAnonKey = 'sb_publishable_wwRP5F9y-_mDNDMJXTueag_GTbvU3Qj'
...
async function syncData() {
  console.log('Syncing complete portfolio dataset to Supabase project qagyqmnreozzksfgsuft...')
  ...
  if (error) {
    ...
    console.log('Successfully synced 100% of data to Supabase table public.app_data!')
  }
}
